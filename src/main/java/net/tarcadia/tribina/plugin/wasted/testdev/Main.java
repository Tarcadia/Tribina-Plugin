...
import net.tarcadia.tribina.plugin.wasted.testdev.commands.T000;
import net.tarcadia.tribina.plugin.wasted.testdev.commands.T001;
import net.tarcadia.tribina.plugin.wasted.testdev.commands.T002;
